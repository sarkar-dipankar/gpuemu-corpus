...
- **P2** — *Operator-Aware Mixed-Precision Tolerance Calibration for Tensor Kernels*.
- **P3** — *Test-Input Generation for Tensor Programs: What Actually Finds Kernel Bugs*.
- **P4** — *Static PTX Metrics Track Structural Kernel Regressions but Miss Semantic Ones*.
